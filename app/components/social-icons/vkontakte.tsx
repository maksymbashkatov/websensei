export default function VKontakte(
  { vkontakteIconStyle, vkontakteIconBackStyle }:
  { vkontakteIconStyle: string, vkontakteIconBackStyle: string }
) {
  return (
    <svg
      viewBox='0 0 101 100'
      ...
      height='32'
      fill='none'
      className={vkontakteIconStyle}
    >
      <path
        className={vkontakteIconBackStyle}
